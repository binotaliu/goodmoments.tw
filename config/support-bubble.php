...
return [
     ...
     */
    'mail_to' => env('SUPPORT_BUBBLE_MAIL_TO'),
    ...
    'classes' => [
        ...
        'bubble' => 'hidden sm:block bg-wood-500 rounded-full shadow-lg w-14 h-14 text-white p-4',
        'input' => 'bg-white border border-gray-200 w-full max-w-full p-2 rounded-sm shadow-input text-gray-800 text-base',
        'button' => 'inline-flex center-center px-4 py-3 h-10 border-0 bg-wood-500 hover:bg-wood-600 active:bg-wood-600 overflow-hidden rounded-sm text-white leading-none no-underline',
    ],
